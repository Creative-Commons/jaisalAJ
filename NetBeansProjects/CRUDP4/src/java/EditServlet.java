...
public class EditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Student s=Studb.getStudentByRollno(rollno);  
          
        out.print("<form action='EditServlet2' method='post'>");  
        out.print("<table>");  
        out.print("<tr><td></td><td><input type='hidden' name='rollno' value='"+s.getRollno()+"'/></td></tr>");  
        ...
        out.print("<tr><td>Class:</td><td><input type='text' name='class1' value='"+s.getclass()+"'/></td></tr>");  
