...
public class EO extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        System.out.println("Initialized");//To change body of generated methods, choose Tools | Templates.
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(no%2==0){
                out.print(no + "is an even number");
            }else{
                out.print(no + "is an odd number");
            }
        }catch(Exception ex){
            ex.printStackTrace();
        }
